  ...
  for (let i = 0; i < 200; i++) {
    ...
    items.push(
      <div className=" flex rounded text-sm font-bold justify-center items-center relative m-4 bg-slate-100">
        <div
          style={{ background: `-webkit-linear-gradient(left,#${hexcode}ff,#${hexcode}ee,#${hexcode}dd,#${hexcode}cc,#${hexcode}bb,#${hexcode}aa,#${hexcode}99,#${hexcode}88,#${hexcode}77,#${hexcode}66,#${hexcode}55,#${hexcode}44,#${hexcode}33,#${hexcode}22,#${hexcode}11,#${hexcode}00` }}
